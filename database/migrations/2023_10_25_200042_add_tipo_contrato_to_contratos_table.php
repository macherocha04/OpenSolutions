...
return new class extends Migration
{
    public function up()
    {
        Schema::create('solicitudes', function (Blueprint $table) {
            ...
            $table->unsignedInteger('Estado_id'); // Clave foránea para la tabla estados
            $table->unsignedInteger('Solicitante_id'); // Clave foránea para la tabla solicitantes
            $table->string('Tipo_solicitud'); // Tipo de solicitud
